...
namespace tests
{
    public class Tests
    {
        ...
        public void SumMainDiagonal()
        {
            ...
            double result = 17;
            double actual = MathFunctions.SumMainDiagonal(A);
        ...
        public void Form_Massiv_X()
        {
            ...
            int m = 3;
            double B = 5;
            double[] X = MathFunctions.CalcArrayX(C, A, m, B);
        ...
        {
            MathFunctions bl = new MathFunctions();
            double h =  1;
            double[] X = { 40.715, 0.802, 7.65 };
            double[] Y = MathFunctions.CalcArrayY(X,h);
